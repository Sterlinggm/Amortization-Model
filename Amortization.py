...
df, stats = amortization_table(int(raw_input('principal: ')), float(raw_input('interest: ')), int(raw_input('year: ')), addl_principal=200, start_date=date(2016, 1,1))
stats
...
fig.savefig('interestpayments.png')
...
fig.savefig('payofftimeline2.png')
